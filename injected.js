...
(function () {
  ...
  function markAiCard(card) {
    ...
    badge.innerHTML = '<span style="opacity:0.7;margin-right:4px;">&#x2B22;</span> AI-DISCLOSED';
  ...
  function showWatchPageBanner() {
    ...
    const svgLarge = `<svg viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg" style="width:32px;height:32px;"><rect x="1" y="1" width="20" height="20" rx="5" stroke="rgba(255,255,255,0.4)" stroke-width="1.5"/><path d="M6 8 L11 5 L16 8 L16 14 L11 17 L6 14 Z" stroke="rgba(255,255,255,0.9)" stroke-width="1.5" fill="none" stroke-linejoin="round"/><circle cx="11" cy="11" r="2" fill="rgba(255,255,255,0.9)"/></svg>`;
    overlay.innerHTML =
      '<div class="sf-yt-ov-icon">' + svgLarge + '</div>' +
